...
pub struct CliOpts {
    ...
    pub chain_spec: node_cli::chain_spec::ChainSpec,
}
    ...
    pub fn parse() -> Self {
        ...
        if spec.is_some() {
            match spec {
                ...
                Some("") | Some("local") => {
                    chain_spec = node_cli::chain_spec::local_testnet_config();
                }
                // path => {
                //     chain_spec = node_cli::chain_spec::ChainSpec::from_json_file(
